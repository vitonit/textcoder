...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] functionsArg = {2, 3, 3, 3, 5, 4, 2, 10, 20, 8, 8, 4, 6, 10, 20, 5, 6, 7, 8, 7, 8, 1, 3, 4, 5, 7, 2, 4, 5, 10, 10};
        // char[] functions = {'2', '3', '3', '3', '5', '4', "2", "10", "20", "8", "8", "4", "6", "10", "20", "5", "6", "7", "8", "7", "8", "1", "3", "4", "5", "7", "2", "4", "5", "10", "10"};
        // char[] functions = {'2', '3', '3', '3', '5', '4'};
        String[] functions = {"+", "-", "/", "*", "+", "-", "/", "*", "+", "-", "+", "-", "/", "*", "+", "-", "/", "*", "+", "-", "/", "*", "+", "-", "/", "*", "+", "-", "/", "*", "+"};
        ...
        String currentDate = scc.nextLine(); // Enter the date of departure of the message

        int DayOfMonth = Integer.parseInt(currentDate.substring(0, 2));  // We allocate from the date the number of the day
        int dataShiftResult = DayOfMonth + dataShift;  // We shift the date
        ...
        int[] textCodesArray = new int[textArray.length];  // &&&&777
        int k = 0;
            ...
            if (parameterOne[j].equals(functions[dataShiftResult])) {
                ...
                switch (indexFunction) {
                    case 0:
                        ...
                        for (int i = 0; i < textArray.length; i++) {
                            finalTextCode[i] = textCodesArray[i] + functionsArg[dataShiftResult];
